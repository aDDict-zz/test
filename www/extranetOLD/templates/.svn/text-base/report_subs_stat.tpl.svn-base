...
<TD HEIGHT="37"><span class='szovegvastag'>&nbsp;{DOCTITLE}<br>{GTITLE} {group_lower}<br></span>
</TD>
</TR>
</TABLE>
   ...
   <TD>      
      <TABLE WIDTH="100%" BORDER="0" BGCOLOR="#FFFFFF" CELLSPACING="0" cellpadding='0'>			
                <tr> 
                  ...
                  <td class="formmezo" width="274" align="center"><span class="alcim">{t_members}</span></td> 
                </tr>
                <tr> 
...
<!-- BEGIN DYNAMIC BLOCK: list_row -->			
                ...
                <tr> 
                 ...
                 <td class="{TD_STYLE}" width="274" align="right"><span class="font1">{SUBSNUM}&nbsp;</span></td>
                </tr>
<!-- END DYNAMIC BLOCK: list_row -->	
                ...
                <tr> 
                  ...
                  <td class="bggray" width="274" align="right"><span class="font1">{SUBSNUM_SUM}&nbsp;</span></td>
                </tr>
              </table>
       ...
       <img src="images/spacer.gif" width="4" height="3">
                ...
                <tr> 
                  <td class="bggray" align="center" valign="center" width=100%>
       <img src="grafnew/bars.php?id={ID}&cache_id={CACHE_ID}&end_daynum={END_DAYNUM}&start_daynum={START_DAYNUM}&desc={DESC}&shrink=50" align="center" valign="center">
                  </td>
                </tr>
                <tr> 
                  <td class="bggray" align="center" valign="center" width=100%>
