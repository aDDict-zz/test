...
//	************************************************************
	...
	function clear_parse2 ( $ReturnVar = "")
	{
...
//	************************************************************
//  assign_same: assigning to var the value from language files, with the same var name 
//  $tpllist is array of these varnames 
//  t. b. janos 2001-12-28

	function assign_same ($tpllist)
    {
        global $_MX_var,$word;
		if (gettype($tpllist) == "array")
            while ( list (,$val) = each ($tpllist) )
                $this->assign($val,$word["$val"]);
    }
