		...
		if(IE){
			...
			if(closeable==1){				
				switch(parseInt(type)){
					...
					case 4:var closeLink = editDiv.childNodes[3];break;
					case 5:var closeLink = editDiv.childNodes[(editable ? 3 : 1)];break;
				}	
			...
			if((type==1) || (type==4) || ((type==5) && (editable == 1))){							
			...
			if(closeable==1) {
                var closeLink;
                if (!(closeLink = editDiv.childNodes[(editable ? 3 : 1)])) closeable = 0;
            }
