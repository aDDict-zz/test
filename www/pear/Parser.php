 ...
 * @version    CVS: $Id: Parser.php,v 1.22 2006/07/27 13:54:17 jystewart Exp $
 ...
 * clean.
 */
require_once '../pear/Parser/Type.php';

/**
 * We will throw exceptions when errors occur.
 */
require_once '../pear/Parser/Exception.php';
...
class XML_Feed_Parser implements Iterator
{
    ...
    function __construct($feed, $strict = false, $suppressWarnings = false, $tidy = false)
    {
        ...
        switch (true) {
            case ($doc_element->namespaceURI == 'http://www.w3.org/2005/Atom'):
                require_once '../pear/Parser/Atom.php';
                require_once '../pear/Parser/AtomElement.php';
            ...
            case ($doc_element->namespaceURI == 'http://purl.org/rss/1.0/' || ($doc_element->hasChildNodes() && $doc_element->childNodes->length > 1  && $doc_element->childNodes->item(1)->namespaceURI == 'http://purl.org/rss/1.0/')):
                require_once '../pear/Parser/RSS1.php';
                require_once '../pear/Parser/RSS1Element.php';
            ...
            case ($doc_element->namespaceURI == 'http://purl.org/rss/1.1/' || 
                ...
                require_once '../pear/Parser/RSS11.php';
                require_once '../pear/Parser/RSS11Element.php';
            ...
            case (($doc_element->hasChildNodes() && $doc_element->childNodes->length > 1
                ...
                require_once '../pear/Parser/RSS09.php';
                require_once '../pear/Parser/RSS09Element.php';
            ...
            case ($doc_element->tagName == 'rss' and
                ...
                require_once '../pear/Parser/RSS2.php';
                require_once '../pear/Parser/RSS2Element.php';
	...
	#$feed = new XML_Feed_Parser('http://onlinemarketing.blog.hu/atom');
	/*
	$url = 'http://sztahanov.blog.hu/rss';
	...
	$smarty->display('cache_rss.html', md5($url));
	*/
?>