    ...
    <tr>
        <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr class="tal" valign="middle" style="background-color:#FFFFFF;"> 
                    <td height="22">
                        <span class='szovegvastag'>&nbsp;{ct_all}</span><br>
                    </td>
                    <td class="tar">
       ...
       />-->
                	    ...
                	    <script type="text/javascript">
                            ...
                            encodeURIComponent("{BASEURL}/amcharts/maxima/settings.php?id={ID}&cache_id={CACHE_ID}&end_daynum={END_DAYNUM}&start_daynum={START_DAYNUM}&desc={DESC}&language={language}&type=ct"));
                            so2.addVariable("data_file",
                            encodeURIComponent("{BASEURL}/amcharts/maxima/xml.php?id={ID}&cache_id={CACHE_ID}&end_daynum={END_DAYNUM}&start_daynum={START_DAYNUM}&desc={DESC}&language={language}&type=ct"));
      ...
      <table width="100%" border="0" bgcolor="#FFFFFF" cellspacing="0" cellpadding='0'>			
                <tr> 
                  ...
                  <td class="formmezo" width="247" align="center"><span class="alcim">{ct_ct_ct}</span></td> 
                </tr>
                <tr> 
...
<!-- BEGIN DYNAMIC BLOCK: list_row -->			
                ...
                <tr> 
				  ...
				  <a href="clickthrough_group.php?group_id={GROUP_ID}&lyear={YEAR}&dostat=1">{YEARNAME}</a>&nbsp;</td>
                  <td class="{MONTHSTYLE}" width="87" align="center"><span class="font1">
				  <a href="clickthrough_group.php?group_id={GROUP_ID}&lyear={YEAR}&lmonth={MONTH}&dostat=1">{MONTHNAME}</a>&nbsp;</td> 
                  <td class="{DAYSTYLE}" width="105" align="left"><span class="font1">
				  <a href="clickthrough_group.php?group_id={GROUP_ID}&lyear={YEAR}&lmonth={MONTH}&lday={DAY}&dostat=1">{DAYNAME}</a>
...
<!-- END DYNAMIC BLOCK: list_row -->	
                ...
                <tr> 
                  ...
                  <td class="bggray" width="247" align="right"><span class="font1">{ALLNUM_SUM}&nbsp;{PERCENT}</span></td>
                </tr>
              </table>
    </td>
  </tr>
