...
function selected(cal, date) {
	...
	if (cal.sel.name=="filt_datumdo") document.dateto.submit();
	if (cal.sel.name=="filt_datumod") document.datefrom.submit();
    if(document.getElementById("godinaPredmeta")){
        document.getElementById("godinaPredmeta").innerHTML=date.substr(6,4);
    }
}
