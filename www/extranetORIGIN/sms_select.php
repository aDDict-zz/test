...
$res=mysql_query("select count(*) from sms_send where group_id='$group_id'");
...
$res=mysql_query("select * from sms_send where group_id='$group_id' $order limit $first,$maxPerPage");
...
if ($res && mysql_num_rows($res)) { 
    ...
    print "
        ...
        <TD class=bgkiemelt2 width='30%'><span class='szovegvastag'>$word[t_date]</span></TD>
        <TD class=bgkiemelt2 width='50%'><span class='szovegvastag'>$word[t_message]</span></TD>
        </TR>\n";
    while($row=mysql_fetch_array($res)) {
        ...
        print "<TR>
               ...
               <TD $tdclass vAlign=top width='50%'><SPAN class=szoveg>"
  ...
  $params="group_id=$group_id&spec=$spec&wizard=$wizard";  
    ...
    if ($first>0)
        echo "<td nowrap align='right'>
           <a href='$_MX_var->baseUrl/sms_select.php?$params&first=0'><img src='$_MX_var->baseUrl/$_MX_var->application_instance/gfx/down2.gif' width='20' height='14' border='0'></a>
           <a href='$_MX_var->baseUrl/sms_select.php?$params&first=$OnePageLeft'><img src='$_MX_var->baseUrl/$_MX_var->application_instance/gfx/down1.gif' width='20' height='14' border='0'></a>
           </td>\n";
    else
        echo "<td nowrap align='right'>&nbsp;&nbsp;
    ...
    if ($first<$LastPage)
        echo "<td nowrap align='right'> &nbsp;
            <a href='$_MX_var->baseUrl/sms_select.php?$params&first=$OnePageRight'><img src='$_MX_var->baseUrl/$_MX_var->application_instance/gfx/up1.gif' width='20' height='14' border='0'></a>
            <a href='$_MX_var->baseUrl/sms_select.php?$params&first=$LastPage'><img src='$_MX_var->baseUrl/$_MX_var->application_instance/gfx/up2.gif' width='20' height='14' border='0'></a>
            &nbsp; </td>\n";
    else
        echo "<td nowrap align='right'>&nbsp;&nbsp;
