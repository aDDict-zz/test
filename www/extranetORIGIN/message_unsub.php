...
logger("",$group_id,"","message_id=$message_id","unsub");	

$res=mysql_query("select count(distinct v.user_id) from validation v,users_$title u where 
                  v.message_id='$message_id' and v.group_id='$group_id' and v.action='unsub'  
                  and v.validated='yes' and v.user_id=u.id");
if ($res && mysql_num_rows($res))
...
$res=mysql_query("select distinct u.ui_email from validation v,users_$title u where 
                  v.message_id='$message_id' and v.group_id='$group_id' and v.action='unsub'  
                  and v.validated='yes' and v.user_id=u.id $order limit $first,$maxPerPage");
...
function PrintHead() {
    ...
    echo "<span class='szovegvastag'>$explain<br><A href='message_unsub_csv.php?group_id=$group_id&message_id=$message_id' class='vastag' target='_blank'>CSV export</a></span><br><br>
  ...
  $params="group_id=$group_id&message_id=$message_id";  
    ...
    if ($first>0)
        echo "<td nowrap align='right'>
           <a href='$_MX_var->baseUrl/message_unsub.php?$params&first=0'><img src='$_MX_var->baseUrl/$_MX_var->application_instance/gfx/down2.gif' width='20' height='14' border='0'></a>
           <a href='$_MX_var->baseUrl/message_unsub.php?$params&first=$OnePageLeft'><img src='$_MX_var->baseUrl/$_MX_var->application_instance/gfx/down1.gif' width='20' height='14' border='0'></a>
           </td>\n";
    else
        echo "<td nowrap align='right'>&nbsp;&nbsp;
    ...
    if ($first<$LastPage)
        echo "<td nowrap align='right'> &nbsp;
            <a href='$_MX_var->baseUrl/message_unsub.php?$params&first=$OnePageRight'><img src='$_MX_var->baseUrl/$_MX_var->application_instance/gfx/up1.gif' width='20' height='14' border='0'></a>
            <a href='$_MX_var->baseUrl/message_unsub.php?$params&first=$LastPage'><img src='$_MX_var->baseUrl/$_MX_var->application_instance/gfx/up2.gif' width='20' height='14' border='0'></a>
            &nbsp; </td>\n";
    else
        echo "<td nowrap align='right'>&nbsp;&nbsp;
