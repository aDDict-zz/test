...
$Xmfppage=get_cookie("Xmfppage");
$maxPerPage = (isset($_GET['maxPerPage']) || empty($Xmfppage)) ? get_http('maxPerPage',25) : $Xmfppage;
...
$qmain=" from xmlreq where group_id='$group_id' and ext_dl='no'";
...
if ($maxrecords) {
    ...
    if ($rst && mysql_num_rows($rst)) {
        ...
        if ($index%2)
           ...
           $bgrnd="bgcolor=white";
        echo "<tr><td class='bgkiemelt2' align=left width=17%><span class=szovegvastag>$word[job_date]</span></td>
              <td class='bgkiemelt2' align=left width=17%><span class=szovegvastag>$word[job_type]</span></td>
              <td class='bgkiemelt2' align=left width=20%><span class=szovegvastag>$word[job_description]</span></td>
              <td class='bgkiemelt2' align=left width=15%><span class=szovegvastag>$word[job_status]</span></td>
              <td class='bgkiemelt2' align=left width=31%><span class=szovegvastag>$word[job_errors]</span></td>
              </tr>
              <tr>
        ...
        while($row=mysql_fetch_array($rst)) {
            ...
            echo "<tr>
		          <td $bgrnd align=left width=17%><span class=szoveg>$job_date</span></td>
		          <td $bgrnd align=left width=17%><span class=szoveg>$job_type</span></td>
		          <td $bgrnd align=left width=20%><span class=szoveg>$job_description</span></td>
		          <td id='reqdiv$row[id]' $bgrnd align=left width=15%><span class=szoveg>$job_status</span></td>
		          <td id='reqerr$row[id]' $bgrnd align=left width=31%><span class=szoveg>$messages $loglink</span></td>
		          </tr>\n";
        }
        printnavigation();
    }
